...
const TREE=[
 ...
 {id:'d2',b:'def',i:1,cost:{gold:700},wave:3,tag:'NAN',name:'NANOBOTS',desc:'Regeneración continua: +10 PS/s (1 vida = 100 PS · vida completa cada 10 s).',fx:b=>b.regenRate+=.1},
 ...
 {id:'d6',b:'def',i:5,cost:{gold:2400},wave:15,tag:'RE2',name:'REGEN PLUS',desc:'Regeneración x3: +30 PS/s (vida completa cada 3.3 s).',fx:b=>b.regenRate+=.2},
